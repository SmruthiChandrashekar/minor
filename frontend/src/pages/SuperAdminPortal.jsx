...
const SuperAdminPortal = () => {
  ...
  const [tab, setTab] = useState("staff"); // "staff" or "audit"
                ...
                <form onSubmit={handleInviteSubmit}>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6 mb-3">
                      ...
                      <input type="text" className="form-control" value={inviteData.department} onChange={e => setInviteData({...inviteData, department: e.target.value})} required />
                    </div>
                  </div>
